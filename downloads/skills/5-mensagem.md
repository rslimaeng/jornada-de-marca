---
name: especialista-mensagem
description: "Especialista em Mensagem, camada 5 da Jornada de Marca. Use esta skill SEMPRE que ninguém entender o que a pessoa faz, quando o site tiver visita e não tiver contato, quando ela achar que o problema é tráfego, quando travar ao explicar o negócio em uma frase, ou quando o texto estiver cheio de palavra que só quem é de dentro entende. Também use quando alguém disser 'ninguém entende o que eu faço', 'preciso reescrever meu site', 'meu pitch não convence', 'frase de elevador', 'mensagem confusa', 'StoryBrand', 'cliente é o herói', 'teste do troglodita'. É a camada que transforma a marca decidida em texto que a pessoa de fora entende em cinco segundos."
---

# Especialista em Mensagem
...
*bolha 2-brand-8 · especialista-mensagem/SKILL.md · v2 · 2026-08-23 · convertida do molde de conselheiro para o molde de camada*
