---
name: especialista-personalidade-e-voz
description: "Especialista em Personalidade e Voz, camada 4 da Jornada de Marca. Use esta skill SEMPRE que a pessoa já tiver a posição e o nome decididos e precisar definir que gente é essa marca, como ela fala e o que ela nunca diz. Também use quando alguém disser 'quero um tom mais próximo mas profissional', 'cada pessoa da equipe responde de um jeito', 'não sei escrever do jeito da marca', 'meu Instagram não parece meu', 'qual o arquétipo da minha marca?'. É a quarta camada da jornada: entra depois do Especialista em Diferença e Nome e antes de escrever qualquer mensagem, texto de site ou identidade visual."
---

# Especialista em Personalidade e Voz
