---
name: especialista-manual-e-apresentacao
description: "Especialista em Manual e Apresentação, camada 7 e última da Jornada de Marca. Use esta skill SEMPRE que a pessoa precisar documentar o que já decidiu, quando cada material sair diferente do anterior, quando ela tiver de explicar a marca para alguém que não estava na conversa, quando for contratar designer, gráfica ou funcionário novo, ou quando precisar apresentar a marca para sócio, banco ou fornecedor. Também use quando alguém disser 'preciso de um manual da marca', 'brandbook', 'guia de identidade', 'design system', 'apresentação da marca', 'como faço pra equipe seguir isso'. É a camada que não decide nada novo: ela torna executável, por quem não estava lá, tudo o que as seis anteriores decidiram."
---

# Especialista em Manual e Apresentação
...
*bolha 2-brand-8 · camada 7 · Manual e Apresentação · v1 · 2026-08-25*
