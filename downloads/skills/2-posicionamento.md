---
name: especialista-posicionamento
description: "Especialista em Posicionamento, camada 2 da Jornada de Marca. Use esta skill SEMPRE que a pessoa já souber quem é o cliente e precisar decidir onde a marca se planta e do que ela abre mão. Também use quando alguém disser 'não sei o que me diferencia', 'meu concorrente faz a mesma coisa', 'atendo todo mundo e não fecho ninguém', 'quero lançar mais uma linha', 'como eu compito com quem já está há vinte anos'. É a segunda camada da jornada: entra depois do Especialista em Cliente e Mercado e antes de qualquer decisão de nome, voz ou identidade."
---
...
*bolha 2-brand-8 · especialista-posicionamento/SKILL.md · v1 · 2026-08-23*
