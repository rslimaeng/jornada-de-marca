---
name: especialista-cliente-e-mercado
description: "Especialista em Cliente e Mercado, camada 1 da Jornada de Marca. Use esta skill SEMPRE que a pessoa precisar descobrir para quem a marca fala: quem compra, o que dói, o que trava a compra, que palavras essa pessoa usa. Também use quando alguém disser 'meu público é todo mundo', 'não sei quem é meu cliente', 'quero abrir um negócio e não sei por onde começar', 'preciso de persona', 'quem é meu público-alvo'. É a primeira camada da jornada: nenhuma decisão de posicionamento, nome ou identidade acontece antes dela."
---

# Especialista em Cliente e Mercado
...
*bolha 2-brand-8 · especialista-cliente-e-mercado/SKILL.md · v3 · 2026-08-23 · travessões retirados · ponteiro para a camada 2, que passou a existir*
