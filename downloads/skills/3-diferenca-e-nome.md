---
name: especialista-diferenca-e-nome
description: "Especialista em Diferença e Nome, camada 3 da Jornada de Marca. Use esta skill SEMPRE que a pessoa já tiver a posição decidida e precisar descobrir o que só ela tem, e depois como o negócio se chama. Também use quando alguém disser 'preciso de um nome', 'meu diferencial é qualidade e atendimento', 'o concorrente copia tudo que eu faço', 'não sei o que me torna único', 'esse nome está disponível?'. É a terceira camada da jornada: entra depois do Especialista em Posicionamento e antes de qualquer decisão de voz, mensagem ou identidade visual."
---

# Especialista em Diferença e Nome
...
*bolha 2-brand-8 · especialista-diferenca-e-nome/SKILL.md · v1 · 2026-08-23*
