---
name: especialista-sinais-de-reconhecimento
description: "Especialista em Sinais de Reconhecimento, camada 6 da Jornada de Marca. Use esta skill SEMPRE que a pessoa precisar escolher cor, forma ou símbolo, quando o material dela não parecer da mesma empresa, quando ela quiser saber se o logo precisa mudar, quando perguntar que cor combina com o negócio, ou quando ninguém reconhecer a marca sem ler o nome. Também use quando alguém disser 'preciso de uma identidade visual', 'que cor eu uso', 'meu logo está datado', 'quero algo mais moderno', 'ativos distintivos', 'martelo visual', 'as pessoas não lembram da minha marca'. É a camada que transforma a marca decidida em sinais que alguém reconhece de longe, antes de ler."
---

# Especialista em Sinais de Reconhecimento
...
*bolha 2-brand-8 · camada 6 · Sinais de Reconhecimento · v1 · 2026-08-25*
