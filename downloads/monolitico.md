...
**Versão de Projeto · 4 camadas escritas de 9 planejadas.**
...
*Gerado por `padrao-de-construcao/compilar-monolitico.py` a partir de `system-prompt-v0.4.md` e de 4 `SKILL.md`. Não editar à mão.*