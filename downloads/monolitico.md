...
**Versão de Projeto · 6 camadas escritas de 9 planejadas.**
...
*Gerado por `padrao-de-construcao/compilar-monolitico.py` a partir de `system-prompt-v0.8.md` e de 6 `SKILL.md`. Não editar à mão.*